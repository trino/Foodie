<div class="slide">
    <div class="text">We'll bring the customers to you    <h3>Put your menu online. Average revenue increase ranging 15-25% a year!</h3>
    </div>
</div>

    <div class="heading"><div class="text"><b>How</b> It Works</div></div>
...
You'll only pay on orders we send you
       ...
       <button class="btn-3">Sign Up Now </button></div>
    </div>
...
<!--div class="test"><div class="black">
    <div class="simple">
        <div class="texted"><b>Happy</b> Customers</div>
    </div>
