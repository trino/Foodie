      ...
      <aside class="sidebar  sidebar--shop">
        ...
        <div class="shop-filter">
          ...
          <ul class="list-group margin-bottom-25 sidebar-menu">
            ...
            <li class="list-group-item clearfix"><a href="<?php echo $this->request->webroot;?>restaurants/orders/pending"><i class="fa fa-angle-right"></i> Pending Orders<span class="notification">(10)</span></a></li>
