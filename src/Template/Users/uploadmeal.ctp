	...
	<div class="col-md-4" style="margin-top:40px">
		...
		<?php echo $this->Form->create('filename', array('class'=>'form-horizontal','action'=>'uploadmeal','enctype' => 'multipart/form-data', 'type' => 'file'));?>
			<fieldset>
				...
				<div class="form-group">
					<label class="col-lg-4 col-sm-4 control-label col-xs-12" for="Meal_Name">Meal Name<span class="require">*</span></label>
					<div class="col-lg-8 col-sm-8">
						<input type="text" name="Meal_Name" required class="form-control" value="">
					</div>
				</div>
				<div class="form-group">
					<label class="col-lg-4 col-sm-4 control-label col-xs-12" for="Image">Image<span class="require">*</span></label>
					<div class="col-lg-8 col-sm-8">
				...
				<div class="form-group">
					<label class="col-lg-4 col-sm-4 control-label col-xs-12">Image Preview</label>
					<div id="image-preview" class="col-lg-8 col-sm-8">
